    ...
    manager : function () {
      ...
      GenkiModal.open({
        ...
        '<ul class="genki-settings-list">'+
          ...
          '<li>'+
            '<span class="label" title="Changes the orientation used for drag and drop vocabulary exercises.">Drag and Drop Mode:</span>'+
          ...
          '<li>'+
            '<span class="label" title="Changes the range for the Random Exercise button in the exercise list.\nChange to Current Lesson if you want to avoid exercises above your current level.">Random Exercise Range:</span>'+
          ...
          '<li>'+
            '<span class="label" title="Enable or disable the stroke order display in stroke order exercises.">Stroke Order:</span>'+
          ...
          '<li>'+
            '<span class="label" title="Enable or disable the tracing guide display in stroke order exercises.">Tracing Guide:</span>'+
